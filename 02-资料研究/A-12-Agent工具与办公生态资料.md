...
- 官方桌面端说明：https://help.openai.com/en/articles/9275200-downloading-the-chatgpt-macos-app
- 页面只标注“通用桌面 Agent”，不展开功能、套餐或连接器数量。

### Claude Desktop

- 官方下载页：https://claude.com/download?m=1
- 官方安装说明：https://support.anthropic.com/en/articles/10065433-installing-claude-for-desktop
- 页面只标注“通用桌面 Agent”，不写未经企业环境验证的连接能力。

### 钉钉与 QoderWork

- QoderWork 官网：https://qoderwork.com/zh/
- 阿里云 QoderWork 快速开始：https://www.alibabacloud.com/help/en/lingma/qoderwork-cn/getting-started/quick-start
- QoderWork 属于阿里云相关产品体系，但当前资料不足以把它写成“原生集成钉钉”。页面只以同一生态下的优先候选关系呈现。
...
页面不显示集团 Logo。所有产品名称、区域标题、环境标签和结论均为可编辑网页文字，Logo 只承担品牌识别。

## 讲述边界

- 不比较价格、模型、部署、安全等级或产品排名。
- 不把“同一生态”说成必须选择，也不把不同生态说成无法连接。
- 企业选择时仍需核对企业版能力、连接器、管理员权限、数据去向和现有采购条件。
